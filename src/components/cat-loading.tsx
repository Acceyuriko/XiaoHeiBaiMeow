export const CatLoading = () => {
  ...
  return (
    <div
      className="cat relative m-auto block h-full animate-loading-cat text-[10px] [&_*]:box-content"
      style={{ width: outterR }}
    >
      <div
        className="body absolute bottom-0 left-0 right-0 top-0 m-auto animate-loading-cat-body rounded-full"
        style={{
          width: outterR,
          height: outterR,
      ...
      <div
        className="foot absolute bottom-0 left-0 right-0 top-0 m-auto animate-loading-cat-foot rounded-full"
        style={{ width: outterR, height: outterR }}
      >
        <div
